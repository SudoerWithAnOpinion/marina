/**
 * Moonraker API Result Types
 *
 * This is a collection of types that are used to define the result of a Moonraker API call.
 * This is not a complete file, nor is it synced to Moonraker's API documentation.
 * Types will be added as this application requires them.
 */
declare namespace MoonrakerAPIResult {
  ...
  interface Configfile {
    ...
    config: Record<string, any> & {
      stepper_x?: ConfiguredStepper;
      stepper_y?: ConfiguredStepper;
      stepper_z?: ConfiguredStepper;
      stepper_z1?: ConfiguredStepper;
    };
  ...
  interface StaticPrinterObjects {
    /**
  ...
  type PrinterObjects = StaticPrinterObjects & { [k as string]: unknown };
