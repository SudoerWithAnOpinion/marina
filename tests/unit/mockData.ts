...
export const jobs: Job[] = [
  ...
  } as Job,
  {
    ...
    createdAt: new Date('2023-01-01T00:05:00.000Z'),
    updatedAt: new Date('2023-01-01T00:05:00.000Z'),
    events: [jobEvents[0], jobEvents[1], jobEvents[2], jobEvents[4]]
  } as Job,
  {
    jobId: 'bfc07ad6-0867-4dde-9c22-4c3832464d38',
    ...
    createdAt: new Date('2023-01-01T00:05:00.000Z'),
    updatedAt: new Date('2023-01-01T00:05:00.000Z'),
    events: [jobEvents[0], jobEvents[1], jobEvents[2], jobEvents[5], jobEvents[6]]
  } as Job,
  {
    jobId: 'bfc07ad6-0867-4dde-9c22-4c3832464d38',
    ...
    createdAt: new Date('2023-01-01T00:05:00.000Z'),
    updatedAt: new Date('2023-01-01T00:05:00.000Z'),
    events: [jobEvents[0], jobEvents[1], jobEvents[2], jobEvents[3], jobEvents[5], jobEvents[7]]
  } as Job
];
